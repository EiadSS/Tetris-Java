...
public class SaveView {
    ...
    public void saveBoard()  {
        File name = new File("boards" + saveFileNameTextField.getText());
        try{
            boolean idk = name.createNewFile();
            if (saveFileNameTextField.getText().endsWith(".ser")&&idk) {
                tetrisView.model.saveModel(name);
